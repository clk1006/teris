            ...
            <main className={styles.main}>
                ...
                <div className="container">
                    <div className="content-block visualization-guide">
                        ...
                        <p>There are <b>2 ways</b> in which you can visualize your work and access the API.</p>
                        ...
                        <p className='code-field'>https://teris-api.vercel.app<br/>
                            or<br/>
                        ...
                        <p className='code-field'>https://teris-api.herokuapp.com/game?<span className='syntax parameter'>gameID</span>=<span className='syntax request'>id</span></p>
                        ...
                        <p>In order to create your own instance of the server you&#39;ll need to have <a href="https://www.docker.com/"
