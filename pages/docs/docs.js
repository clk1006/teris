            ...
            <main className={styles.main}>
                ...
                <div className="container">
                    <div className="content-block">
                        ...
                        <p className="code-field">
                            https://teris-api.vercel.app/api/<br/>
                            or<br/>
                        ...
                        <ul>
                            <li>
                                ...
                                <div className="warning-box">
                                    <p className="error">
                                        <FontAwesomeIcon size="xs" icon={faExclamationTriangle}/> Please be especially careful when accessing this parameter via the public server, as your game may interfere with (multiple) other games.
                        ...
                        <div className="pop-up-info">
                            <div className="info-content-block">
                                ...
                                <div className="info-content">
                                    ...
                                    <p className="code-field">
                                        ...<br/>
                                        terisServer = TerisServer(urlOrigin)<br/>
                                        <br/>
                                        print(terisServer.getState())
                                    </p>
                                    ...
                                    <p>The elements from the list can of course also be accesed individually like
                                        this:</p>
                                    <p className="code-field">
                                        [score, tiles, current, next, gameStatus] = terisServer.getState()<br/>
                                        ...<br/>
                                        print(score)<br/>
                                        <br/>
                                        or<br/>
                                        <br/>
                                        state = terisServer.getState()<br/>
                                        ...<br/>
                                        print(state[i])
                                    </p>
                        ...
                        <div className="pop-up-info">
                            <div className="info-content-block">
                                ...
                                <div className="info-content">
                                    ...
                                    <p className="code-field">
                                        #program logics...<br/>
                                        terisServer.rotateLeft()<br/>
                                        terisServer.moveRight()<br/>
                                        <br/>
                                        terisServer.endTurn()
                                    </p>
